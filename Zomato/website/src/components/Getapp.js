...
const Getapp = () => {
    return (
        <div style={{ backgroundColor: 'rgb(255, 251, 247)', display: 'flex', justifyContent: "center" }}>
            <Image src="https://b.zmtcdn.com/data/o2_assets/02929b00212f71270720274f2ba44b931680582749.png" style={{ height: '68%', width: "30%" }}>
            </Image>
